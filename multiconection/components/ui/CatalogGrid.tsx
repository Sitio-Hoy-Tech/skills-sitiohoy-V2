...
export function CatalogGrid({ products, categories, waLink }: CatalogGridProps) {
  ...
  return (
    <section className="py-12 pb-24" style={{ backgroundColor: "#060D1A" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-wrap gap-3 mb-12">
          <button
            ...
            style={{
              backgroundColor:
                activeCategory === "all" ? "#00B8D4" : "rgba(20,34,64,0.8)",
          ...
          <AnimatePresence mode="popLayout">
            {filtered.map((product) => {
              const imgUrl =
                ...
                `https://loremflickr.com/800/600/led,screen?lock=${product.id.charCodeAt(product.id.length - 1) % 20 + 1}`;
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <h3 className="font-display font-bold text-xl text-white mb-3 flex-1">
                      {product.name}
                    </h3>
                    ...
                    {/* CTA — required: every product has "Más información" → WhatsApp */}
                    <a
                      href={productWaLink}
                      target="_blank"
