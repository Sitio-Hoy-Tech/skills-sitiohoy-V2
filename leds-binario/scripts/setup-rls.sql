...
-- Negocio: Leds Binario
-- Generado: 2026-05-21
-- Ejecutar en: Supabase Dashboard → SQL Editor
-- =============================================
--
-- Este script:
-- 1. Crea el tenant en la tabla tenants (USA el UUID ya provisto)
...
DO $$
DECLARE
  _tenant_id UUID := 'cc02534c-8767-4d50-a00f-2fd9298c1b88';
BEGIN
  INSERT INTO public.tenants (id, name, slug, plan, status, max_products)
  VALUES (_tenant_id, 'Leds Binario', 'leds-binario', 'esencial', 'active', 50)
  ON CONFLICT (id) DO NOTHING;

  RAISE NOTICE '';
  RAISE NOTICE '================================================';
  RAISE NOTICE '  ✅ TENANT LEDS BINARIO';
...
-- =============================================
-- ISR: Agregar columnas url y revalidation_secret al tenant
-- =============================================
...
SET
  url = 'https://ledsbaradero.com',
  revalidation_secret = 'REEMPLAZAR_CON_openssl_rand_hex_32'
WHERE id = 'cc02534c-8767-4d50-a00f-2fd9298c1b88';
